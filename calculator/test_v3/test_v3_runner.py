from calculator.test_v3.test_v3_add import TestAdd
from calculator.test_v3.test_v3_sub import TestSub
from calculator.test_v3.test_v3_div import TestDiv
from calculator.test_v3.test_v3_mul import TestMul
